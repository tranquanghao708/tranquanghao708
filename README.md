...
```yaml
current_focus:    "Reverse Engineering & Binary Exploitation"
learning:         "Vulnerability Research"
languages:        ["C", "Assembly (x86/x64)"]
playground:       "Linux (bare metal & VM)"
philosophy:       "Understand it before you break it."
```
